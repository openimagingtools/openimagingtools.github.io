/**
 * Cloudflare Worker: openimagingtools.com contribute form → GitHub Issue
 *
 ...
 *   GITHUB_REPO   — "openimagingtools/openimagingtools.github.io"
 */

const REDIRECT_BASE = 'https://openimagingtools.com/contribute/';
...
export default {
  async fetch(request, env) {
    ...
    const modality    = (form.get('modality')     || '').trim();
    ...
    const body = [
      ...
      ``,
      `*Submitted via [openimagingtools.com/contribute](https://openimagingtools.com/contribute)*`,
    ].join('\n');
    ...
    const ghResp = await fetch(
      `https://api.github.com/repos/${env.GITHUB_REPO}/issues`,
      {
        ...
        headers: {
          ...
          'User-Agent':           'openimagingtools-webhook-bridge',
        },
        body: JSON.stringify({
